...
import { orgMembershipRoutes } from './routes/org-memberships.js';
import { orgCapacityRoutes } from './routes/org-capacity.js';
...
import { employeeOrgLinksRoutes } from './routes/employee-org-links.js';
...
await fastify.register(orgMembershipRoutes);
await fastify.register(orgCapacityRoutes);
